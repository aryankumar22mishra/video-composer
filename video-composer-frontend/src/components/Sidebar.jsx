...
function Sidebar({ activeSection, onSelectComposer, onSelectRecord, onSelectMedia, onSelectBackground, onSelectZoom, onSelectAgent }) {
  const items = [
    ...
    { key: 'zoom', label: 'Zoom', icon: 'zoom', onClick: onSelectZoom },
